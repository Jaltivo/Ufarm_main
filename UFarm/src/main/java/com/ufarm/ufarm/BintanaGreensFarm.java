 ...
 * @author Jasmine
 */
public class BintanaGreensFarm extends javax.swing.JFrame {

    /**
     * Creates new form BintanaGreensFarm
     */
    public BintanaGreensFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f6 (1).jpg"));  
        ...
        jLabel3.setText("Bintana Greens");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Bangkal, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Homegrown herbs and microgreens, ideal for tea, garnish, or");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("flavoring dishes.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BintanaGreensFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
