 ...
 * @author Jasmine
 */
public class RoofCropCoFarm extends javax.swing.JFrame {

    /**
     * Creates new form RoofCropCoFarm
     */
    public RoofCropCoFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f11.jpg"));  
        ...
        jLabel3.setText("RoofCrop Co.");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Panacan, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Rooftop-grown vegetables using sustainable methods.");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("Farm-to-table freshness in every pack.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoofCropCoFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
