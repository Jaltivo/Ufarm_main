 ...
 * @author Jasmine
 */
public class PlantitaPicksFarm extends javax.swing.JFrame {

    /**
     * Creates new form PlantitaPicksFarm
     */
    public PlantitaPicksFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f14.jpg"));  
        ...
        jLabel3.setText("Plantita Picks");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Indangan, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Stylish and fresh herbs, leafy greens, and vegetable bundles.");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("Gown with love and care.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlantitaPicksFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
