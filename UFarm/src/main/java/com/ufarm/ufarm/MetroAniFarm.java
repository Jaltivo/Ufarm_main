 ...
 * @author Jasmine
 */
public class MetroAniFarm extends javax.swing.JFrame {

    /**
     * Creates new form MetroAni
     */
    public MetroAniFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f2 (1).jpg"));  
        ...
        jLabel3.setText("MetroAni");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Matina Aplaya, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Pesticide-free vegetables grown through modern urban farming");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("systems. Crisp, clean, and ready to enjoy.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MetroAniFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
