 ...
 * @author Jasmine
 */
public class BahayAnihanFarm extends javax.swing.JFrame {

    /**
     * Creates new form BahayAnihanFarm
     */
    public BahayAnihanFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f4 (1).jpg"));  
        ...
        jLabel3.setText("BahayAnihan");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Mintal, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Naturally grown backyard vegetables like okra, eggplant, and");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("malunggay. Picked fresh daily.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BahayAnihanFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
