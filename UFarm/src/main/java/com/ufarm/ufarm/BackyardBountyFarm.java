 ...
 * @author Jasmine
 */
public class BackyardBountyFarm extends javax.swing.JFrame {

    /**
     * Creates new form BackyardBountyFarm
     */
    public BackyardBountyFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f13.jpg"));  
        ...
        jLabel3.setText("Backyard Bounty");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Sasa, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Naturally grown gulay (vegetables) such as ampalaya, squash,");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("and eggplant. Good for family meals.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BackyardBountyFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
