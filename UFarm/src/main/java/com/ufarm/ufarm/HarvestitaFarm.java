 ...
 * @author Jasmine
 */
public class HarvestitaFarm extends javax.swing.JFrame {

    /**
     * Creates new form HarvestitaFarm
     */
    public HarvestitaFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f1 (1).jpg"));  
        ...
        jLabel3.setText("Harvestita");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay 76-A Bucana, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Freshly harvested leafy greens and herbs, grown using organic");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("practices. Perfect for everyday healthy meals.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HarvestitaFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
