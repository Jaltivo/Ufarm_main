 ...
 * @author Jasmine
 */
public class SpaceCropFarm extends javax.swing.JFrame {

    /**
     * Creates new form SpaceCropFarm
     */
    public SpaceCropFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\F17.jpg"));  
        ...
        jLabel3.setText("SpaceCrop Farm");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Tugbok Proper, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Compact farming yields fresh mug bean sprouts, lettuce, and");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("herbs from sustainable setups.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpaceCropFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
