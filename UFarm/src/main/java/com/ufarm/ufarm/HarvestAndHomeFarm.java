 ...
 * @author Jasmine
 */
public class HarvestAndHomeFarm extends javax.swing.JFrame {

    /**
     * Creates new form HarvestAndHomeFarm
     */
    public HarvestAndHomeFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\F18.jpg"));  
        ...
        jLabel3.setText("Harvest & Home");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Toril Proper, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Daily-picked seasonal fruits and vegetables. Naturally grown for");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("healthy home meals.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HarvestAndHomeFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
