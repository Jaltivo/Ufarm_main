 ...
 * @author Jasmine
 */
public class FarmBoxDirectFarm extends javax.swing.JFrame {

    /**
     * Creates new form FarmBoxDirectFarm
     */
    public FarmBoxDirectFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\F16.jpg"));  
        ...
        jLabel3.setText("FarmBox Direct");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Catalunan Pequeno, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Mixed vegetable boxes packed with freshly harvested produce.");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("Ready for delivery or pickup.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FarmBoxDirectFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
