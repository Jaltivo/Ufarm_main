 ...
 * @author Jasmine
 */
public class MuntingTanimanFarm extends javax.swing.JFrame {

    /**
     * Creates new form MuntingTanimanFarm
     */
    public MuntingTanimanFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Cart.setFont(new java.awt.Font("Helvetica Neue", 0, 24));  
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f5 (1).jpg"));  
        ...
        jLabel3.setText("Munting Taniman");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Ma-a, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Affordable and healthy vegetables grown in small container.");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("gardens. Great for home cooking.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MuntingTanimanFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
