 ...
 * @author Jasmine
 */
public class TowerTaniman extends javax.swing.JFrame {

    /**
     * Creates new form TowerTaniman
     */
    public TowerTaniman() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f10.jpg"));  
        ...
        jLabel3.setText("TowerTaniman");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Calinan Proper, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Vertical tower-grown produce including tomatoes, peppers,");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("and herbs. Fresh harvest every week.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TowerTaniman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
