 ...
 * @author Jasmine
 */
public class LeafLevelFarm extends javax.swing.JFrame {

    /**
     * Creates new form LeafLevelFarm
     */
    public LeafLevelFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f12.jpg"));  
        ...
        jLabel3.setText("LeafLevel Farm");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Tibungco, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Carefully cultivated arugula, basil, and lettuce. Great for salads,");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("pastas, and wraps.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LeafLevelFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
