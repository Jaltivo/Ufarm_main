 ...
 * @author Jasmine
 */
public class VertiGrowFarm extends javax.swing.JFrame {

    /**
     * Creates new form VertiGrow
     */
    public VertiGrowFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f9.jpg"));  
        ...
        jLabel3.setText("VertiGrow");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Talomo Proper, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Clean, green vegetables grown vertically. Safe, pesticide-free,");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("and nutrition-packed.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VertiGrowFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
