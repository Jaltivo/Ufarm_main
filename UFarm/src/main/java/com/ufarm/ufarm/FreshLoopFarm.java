 ...
 * @author Jasmine
 */
public class FreshLoopFarm extends javax.swing.JFrame {

    /**
     * Creates new form FreshLoop
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f7.jpg"));  
        ...
        jLabel3.setText("Fresh Loop");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Buhangin Proper, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Sustainably farmed produce using eco-friendly compost systems.");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("Root crops and leafy greens available.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FreshLoopFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
