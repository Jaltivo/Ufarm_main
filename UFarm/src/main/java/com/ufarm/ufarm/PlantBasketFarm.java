 ...
 * @author Jasmine
 */
public class PlantBasketFarm extends javax.swing.JFrame {

    /**
     * Creates new form PlantBasketFarm
     */
    public PlantBasketFarm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Documents\\NetBeansProjects\\Ufarm_main\\UFarm\\src\\main\\java\\com\\ufarm\\ufarm\\images\\f8.jpeg"));  
        ...
        jLabel3.setText("Plant Basket");

        jLabel4.setFont(new java.awt.Font("Helvetica Neue", 2, 14));  
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Located at Barangay Bago Aplaya, Davao City, Davao Del Sur, 8000");

        jLabel5.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel5.setText("Handpicked bundles of pechay, mustasa, and kamote tops.");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 15));  
        jLabel6.setText("Washed , packed, and ready to use.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlantBasketFarm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
